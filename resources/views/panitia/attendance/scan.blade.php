...
<div class="container py-4">
    ...
    <div class="my-3">
        ...
        <input type="file" id="qr-upload" accept="image/*" class="form-control" style="max-width:300px; margin:0 auto;">
    </div>
</div>
...
<script>
    ...
    document.getElementById('qr-upload').addEventListener('change', function(e) {
        ...
        if (!file) return;
        resultDiv.innerHTML = '<span class="text-info fw-semibold"><i class="bi bi-hourglass-split"></i> Memproses gambar QR...</span>';
        const qr = new Html5Qrcode("reader-upload-temp");
