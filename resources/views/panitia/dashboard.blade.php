            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ \Carbon\Carbon::parse($event->start_time)->format('M d, Y') }}<br>
                    <small class="text-muted">{{ \Carbon\Carbon::parse($event->start_time)->format('H:i') }}</small>
                  </td>
                  <td>
                  ...
                  <td>
                    <a href="{{ route('panitia.events.show', $event->id) }}" class="btn btn-sm btn-outline-secondary">Manage</a>
                  </td>
                </tr>
                @empty
                <tr>
                  <td colspan="5" class="text-center text-muted">No active events.</td>
                </tr>
                @endforelse
              </tbody>
            </table>
